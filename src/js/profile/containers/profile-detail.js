...
class UserProfile extends Component {
  ...
  render () {
    ...
    const income = [
      ...
      {value: 'income-1', label: '$35,000 - $50,000'},
      {value: 'income-1', label: '$50,000 - $65,000'},
      {value: 'income-1', label: '$65,000 - $80,000'},
      {value: 'income-1', label: '$80,000 - $95,000'},
      {value: 'income-1', label: '$95,000 - $120,000'},
      {value: 'income-1', label: 'Over $120,000'},
      ];
    ...
    return (
      ...
      <p>Gender: </p>
      <Dropdown auto onChange={this.handleChange} source={gender} value={this.state.value} />
      <p>Race: </p>
      <Dropdown auto onChange={this.handleChange} source={race} value={this.state.value} />
      <p>Political Leaning: </p>
      <Dropdown auto onChange={this.handleChange} source={politicalleaning} value={this.state.value} />
      <p>Industry: </p>
      <Dropdown auto onChange={this.handleChange} source={industry} value={this.state.value} />
      <p>Religion: </p>
      <Dropdown auto onChange={this.handleChange} source={religion} value={this.state.value} />
      <p>Income: </p>
      <Dropdown auto onChange={this.handleChange} source={income} value={this.state.value} />
