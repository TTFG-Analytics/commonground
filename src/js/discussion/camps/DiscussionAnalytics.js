...
// class DiscussionAnalytics extends React.Component{
//   constructor(props){
//     super(props)
//     this.state = {
//       ages: null,
...
//       axios.get(`/discussionAges/${this.props.discussionId}`)
...
//       axios.get(`/discussionPolitics/${this.props.discussionId}`)
//         .then(function(response) {
...
//     var politicsBarchartData = [{
//       label: 'somethingA',
//       values: [{x: 'SomethingA', y: 10}, {x: 'SomethingB', y: 4}, {x: 'SomethingC', y: 3}]
//     }];
//     if(this.state.politics !== null) {
//       politicsBarchartData = [{
//         label: 'Discussion users by Political Leanings',
...
//       {this.state.showAges && <BarChart data={barchartData} width={800} height={400}
//       margin={{top: 10, bottom: 50, left: 50, right: 10}} />}
//       <button onClick={()=>this.getPolitics()}>Get political leanings of commenters</button>
//       {this.state.showPolitics && <BarChart data={politicsBarchartData} width={800} height={400}
//       margin={{top: 10, bottom: 50, left: 50, right: 10}} />}
//       </div>
//     )
//   }
